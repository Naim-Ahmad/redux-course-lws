...
import { deleteData } from "../../redux/inputData/actions"
    ...
    <div className="table-container">
      <table className="booking-table">
        ...
        <tbody className="divide-y divide-gray-300/20" id="lws-previewBooked">
          {/* <!-- Row 1 --> */}
          {
            inputData.length === 0 ? <tr className="lws-bookedTable text-black" style={{textAlign: "center"}}>No Booking.</tr> :
            inputData.map((data, ind) => (
              <tr key={ind} className="lws-bookedTable text-black">
                ...
                <td className="px-6 py-4 text-center">
                  <div className="flex justify-center gap-4">
                    <button onClick={()=> dispatch(deleteData({ind}))} className="lws-remove">
