...
import { findJob, updateJob } from "../../redux/job/jobSlice";
      ...
      <div className="max-w-3xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="fieldContainer">
            ...
            <select defaultValue={job?.title} id="lws-JobTitle" name="lwsJobTitle" required>
          ...
          <div className="fieldContainer">
            ...
            <select defaultValue={job?.type} id="lws-JobType" name="lwsJobType" required>
          ...
          <div className="fieldContainer">
            ...
            <div className="flex border rounded-md shadow-sm border-slate-600">
              ...
              <input defaultValue={job?.salary} type="number" name="lwsJobSalary" id="lws-JobSalary" required className="!rounded-l-none !border-0"
          ...
          <div className="fieldContainer">
            ...
            <input  defaultValue={job?.deadline} type="date" name="lwsJobDeadline" id="lws-JobDeadline" required />
          </div>
