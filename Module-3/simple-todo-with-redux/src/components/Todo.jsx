...
import { deleteTodo, setColor, swapTodo } from '../redux/todos/actions';
...
export default function Todo(props) {
    ...
    return (
        ...
        >
            ...
            <div
                onClick={() => dispatch(setColor(id, 'green'))}
            ...
            <div
                onClick={() => dispatch(setColor(id, 'yellow'))}
            ...
            <div
                onClick={() => dispatch(setColor(id, 'red'))}
